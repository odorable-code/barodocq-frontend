      ...
      <div className="nav-inner">
        ...
        <div className="nav-top-s2">
          ...
          <div className="nav-search-s2">
            ...
            <input type="text" placeholder="병원명, 전문의, 진료과, 주소 검색" />
            <button className="nav-search-btn-s2">검색 <i className="fas fa-arrow-right" /></button>
          </div>
          ...
          <button className="hamburger-s2" ref={hamburgerRef} onClick={toggleMobileMenu}>
            <span /><span /><span />
          </button>
        </div>
        ...
        <div className="nav-bottom-s2">
          <ul className="nav-menu-s2" ref={navMenuRef}>
            <li><Link to="/pharmacy"><i className="fas fa-pills" />약국</Link></li>
            <li><Link to="/main" className="active"><i className="fas fa-hospital" />병원찾기</Link></li>
