...
const HOT_REVIEWS = [
  {
    ...
    avatar: "이",
    rating: 5,
    text: "대기 시간이 짧고 의사 선생님이 정말 친절하세요. AI 추천으로 처음 방문했는데 완전 만족!",
    time: "2시간 전",
    likes: 47,
  },
  {
    ...
    avatar: "박",
    rating: 5,
    text: "아이가 무서워하지 않도록 선생님이 배려해주셨어요. 시설도 깔끔하고 정말 좋았습니다.",
    time: "4시간 전",
    likes: 38,
  },
  {
    ...
    avatar: "김",
    rating: 5,
    text: "치료 과정을 친절하게 설명해주시고 통증도 최소화해주셨어요. 다음에도 꼭 올 것 같아요!",
    time: "어제",
    likes: 29,
  },
  {
    ...
    avatar: "최",
    rating: 4,
    text: "라식 상담 받았는데 과장 없이 솔직하게 말씀해주셔서 신뢰가 갔어요.",
    time: "어제",
    likes: 22,
  },
];
